...
export function SiteHeader() {
  ...
  return (
    <header className="fixed left-0 right-0 top-0 z-50 w-full border-b border-border/60 bg-background backdrop-blur-none" style={{ WebkitBackfaceVisibility: "hidden" }}>
