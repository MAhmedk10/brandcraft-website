...
const products = [
  ...
  { title: "Die Cut Stickers", href: "/products/die-cut-stickers", image: "/images/die-cut-sticker/die-cut-sticker-5.jpg", imageAlt: "Die cut stickers" },
  { title: "Holographic Stickers", href: "/products/holographic-stickers", image: "/images/holographic-sticker/holographic-sticker-6.jpeg", imageAlt: "Holographic stickers" },
  { title: "Hangtags & Labels", href: "/products/hangtags-labels", image: "/images/hangtags/hangtag-label-1.jpg", imageAlt: "Hangtags and labels" },
  { title: "Custom Apparel", href: "/products/custom-apparel", image: "/images/custom-apparel/custom-apparel-2.jpeg", imageAlt: "Custom apparel" },
  { title: "Hoodies & Tracksuits", href: "/products/hoodies-tracksuits", image: "/images/hoodies/hoodies-2.jpg", imageAlt: "Hoodies and tracksuits" },
  { title: "Letterman Jackets", href: "/products/letterman-jackets", image: "/images/letterman-jackets/letterman-jacket-1.jpg", imageAlt: "Letterman jackets" },
  { title: "Biker Jackets", href: "/products/biker-jackets", image: "/images/biker-jackets/biker-jacket-4.png", imageAlt: "Biker jackets" },
  { title: "Vector Art", href: "/products/vector-art", image: "/images/vector-art/vector-art-2.jpeg", imageAlt: "Vector art services" },
  { title: "Embroidery Digitizing", href: "/products/embroidery-digitizing", image: "/images/embroidery-digitizing/embroidery-digitizing-1.png", imageAlt: "Embroidery digitizing" },
  { title: "Heat Transfer DTF", href: "/products/heat-transfer-dtf-print", image: "/images/heat-dtf/heat-dtf-2.jpeg", imageAlt: "DTF printing" },
]
